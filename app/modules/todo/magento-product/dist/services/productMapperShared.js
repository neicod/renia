 ...
 */
export const mapProductThumbnail = (image) => {
    if (!image?.url)
        return undefined;
    return {
        url: image.url,
 ...
 */
export const mapProductPrice = (priceRange) => {
 ...
 */
export const mapProductPriceOriginal = (priceRange) => {
    if (!priceRange?.minimum_price?.regular_price)
        return undefined;
    return {
 ...
 */
export const mapCommonProductFields = (item) => {
    return {
