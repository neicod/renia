...
export const stripLeadingSlashes = (value: string): string => value.replace(/^\/+/, '');
 ...
 * - "///a/b?x=1" -> "/a/b?x=1"
 */
export const toAbsolutePath = (pathLike: string | null | undefined): string | null => {
 ...
 */
export const dedupeSearch = (search: string | null | undefined): string => {
