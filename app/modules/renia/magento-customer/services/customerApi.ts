...
const buildGenerateTokenMutation = () => {
  ...
  builder.addField([], 'generateCustomerToken', {
    args: {
      email: '$email',
      password: '$password'
    }
...
const buildCreateCustomerMutation = () => {
  ...
  builder.addField([], 'createCustomer', {
    args: {
      input: '$input'
    }
  });
  builder.addField(['createCustomer'], 'customer');
  builder.addField(['createCustomer', 'customer'], 'id');
  builder.addField(['createCustomer', 'customer'], 'email');
  builder.addField(['createCustomer', 'customer'], 'firstname');
  builder.addField(['createCustomer', 'customer'], 'lastname');
  builder.addField(['createCustomer', 'customer'], 'is_subscribed');
  return builder;
};

const buildCustomerQuery = () => {
  const builder = new QueryBuilder('query').setName('CustomerDetails');
  builder.addField([], 'customer');
  builder.addField(['customer'], 'email');
  builder.addField(['customer'], 'firstname');
  builder.addField(['customer'], 'lastname');
  return builder;
};
...
const buildMergeCartsMutation = () => {
  ...
  builder.addField([], 'mergeCarts', {
    args: {
      source_cart_id: '$sourceCartId',
      destination_cart_id: '$destinationCartId'
    }
  });
  builder.addField(['mergeCarts'], 'id');
  return builder;
};
